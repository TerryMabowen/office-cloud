...
var _VERSION = '4.1.12 (2018-11-04)',
		...
		if (window.$) {
			...
			$.ajax({
				...
				success: function(res) {
					self.options.afterUpload.call(self, res);
				},
				error: function(e) {
					alert(e.message);
				}
			...
			var errMsg = '需依赖jquery：由于我们改造了kindeditor，目前依赖jquery将form表单请求转ajax发送';
